...
class Car implements Runnable {
    ...
    public void draw(GraphicsContext gc) {
        ...
        {
            image = new Image("D:/Studies/Synchronization simulator/pictures/cars.png");
            width=20;
            height=40;
        } else if (angle.equals("left")) {
            image = new Image("D:/Studies/Synchronization simulator/pictures/carl.png");
            width=40;
            height=20;
        } else if (angle.equals("right")) {
            image = new Image("D:/Studies/Synchronization simulator/pictures/carr.png");
            width=40;
            height=20;
        } else if (angle.equals("down")) {
            image = new Image("D:/Studies/Synchronization simulator/pictures/card.png");
            width=20;
            height=40;
        }
